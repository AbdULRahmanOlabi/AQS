      ...
      switch (d.videotype) {
        case "youtube":
          if (0 == a.find("iframe").length)
            a.append(a.data("videomarkup")), i(a, c, !0);
          else if (void 0 != d.player.playVideo) {
            var e = f(a.data("videostartat")),
              h = d.player.getCurrentTime();
            1 == a.data("nextslideatend-triggered") &&
              ((h = -1), a.data("nextslideatend-triggered", 0)),
              -1 != e && e > h && d.player.seekTo(e),
              !0 !== d.youtubepausecalled && d.player.playVideo();
          } else
            a.data(
              "videoplaywait",
              setTimeout(function () {
            ...
            g(
              ...
              (function (a) {
                ...
                var d = f(a.data("videostartat")),
                  e = n.currentTime;
                1 == a.data("nextslideatend-triggered") &&
                  ((e = -1), a.data("nextslideatend-triggered", 0)),
                  -1 != d && d > e && (n.currentTime = d);
              })(a)
            );
          else {
            n.play();
    ...
    manageVideoLayer: function (a, d, h, j) {
      ...
      var k = a.data(),
        ...
        w =
          "loop" == k.videoloop
            ? "loop"
            : "loopandnoslidestop" == k.videoloop
            ? "loop"
            : "",
        x =
          void 0 != q || void 0 != r
      ...
      switch (((w = !0 === k.nextslideatend ? "" : w), (k.videotype = x), z)) {
        case "html5":
          ...
          var A = d.fallbacks.allowHTML5AutoPlayOnAndroid
              ? "muted playsinline"
              : "",
            B =
              "<" +
              ...
              p +
              '">';
          "auto" == p && (d.mediapreload = !0),
            void 0 != r &&
              "firefox" == b.get_browser().toLowerCase() &&
              (B = B + '<source src="' + r + '" type="video/webm" />'),
            void 0 != q &&
              (B = B + '<source src="' + q + '" type="video/mp4" />'),
            void 0 != s &&
              (B = B + '<source src="' + s + '" type="video/ogg" />'),
            (B = B + "</" + y + ">");
          var C = "";
          ("true" !== t && !0 !== t) ||
            (C =
        ...
        case "youtube":
          (v = "https"),
            "none" == u &&
              ...
              -1 == m.toLowerCase().indexOf("controls") &&
                (m += "&controls=0")),
            (!0 !== k.videoinline &&
              "true" !== k.videoinline &&
              1 !== k.videoinline) ||
      ...
      if (void 0 != k.videoposter && k.videoposter.length > 2 && !I)
        ...
        0 != a.find("iframe").length ||
          ("youtube" != x && "vimeo" != x) ||
          (a.append(a.data("videomarkup")), i(a, d, !1));
      }
  ...
  var g = function (a, b, c) {
    ...
    i = function (a, d, e) {
      ...
      if (
        ...
        void 0 != q &&
          q.split(":").length > 1 &&
          (console.log("i"), b.prepareCoveredVideo(q, d, a));
      }
      if (1 == a.data("bgvideo")) {
        var q = a.data("aspectratio");
        void 0 != q &&
          q.split(":").length > 1 &&
          (console.log("ak"), b.prepareCoveredVideo(q, d, a));
      }
      if (
        (i.attr("id", l),
        e && a.data("startvideonow", !0),
                  ...
                  if (c.data == YT.PlayerState.PLAYING)
                    ...
                    q ||
                      ...
                      !(
                        ...
                        (1 === a.data("bgvideo") &&
                          a.find(".rs-fullvideo-cover").length > 0)
                      ) ||
                      (1 === a.data("bgvideo")
                        ? punchgs.TweenLite.to(
                            a.find(".rs-fullvideo-cover"),
                            0.1,
                            {
                              autoAlpha: 1,
                              force3D: "auto",
                        ...
                        : punchgs.TweenLite.to(a.find(".tp-videoposter"), 0.1, {
                            autoAlpha: 1,
                            force3D: "auto",
                            ease: punchgs.Power3.easeInOut,
                          }),
                      punchgs.TweenLite.to(a.find("iframe"), 0.1, {
                        autoAlpha: 0,
                        ease: punchgs.Power3.easeInOut,
                      })),
                      -1 != c.data &&
                        ...
                        (void 0 != d.currentLayerVideoIsPlaying &&
                          d.currentLayerVideoIsPlaying.attr("id") !=
                            a.attr("id")) ||
                          b.unToggleState(g.videotoggledby)),
    ...
    l = function (a, e, i) {
      ...
      if (
        ...
        r.data("metaloaded", 1),
        1 != a.data("bgvideo") ||
          ("none" !== l.videoloop && !1 !== l.videoloop) ||
          (t = !1),
      ...
      void 0 != v &&
        ...
        void 0 != w &&
          g(w, "click", function () {
            0 == q.muted
              ? ((q.muted = !0), (w.innerHTML = "Unmute"))
              : ((q.muted = !1), (w.innerHTML = "Mute"));
          }),
        void 0 != x &&
          x &&
          g(x, "click", function () {
            q.requestFullscreen
              ...
              ? q.mozRequestFullScreen()
              : q.webkitRequestFullscreen && q.webkitRequestFullscreen();
          }),
        void 0 != y &&
          (g(y, "change", function () {
        ...
        g(q, "play", function () {
          ...
          (c = void 0 != c && "mute" != c ? parseFloat(c) / 100 : c),
            d ||
              (!0 === e.globalmute ? (q.muted = !0) : (q.muted = !1),
              c > 1 && (c /= 100),
              "mute" == c ? (q.muted = !0) : void 0 != c && (q.volume = c)),
          ...
          m(a, e),
            t && "audio" != f
              ? ((e.videoplaying = !0),
                ...
                e.c.trigger("revolution.slide.onvideoplay", h(q, "html5", l)))
              : ((e.videoplaying = !1),
                "audio" != f && e.c.trigger("starttimer"),
                e.c.trigger("revolution.slide.onvideostop", h(q, "html5", l))),
            punchgs.TweenLite.to(a.find(".tp-videoposter"), 0.3, {
              autoAlpha: 0,
              force3D: "auto",
              ease: punchgs.Power3.easeInOut,
            }),
            punchgs.TweenLite.to(a.find(f), 0.3, {
              autoAlpha: 1,
              display: "block",
              ease: punchgs.Power3.easeInOut,
            });
          ...
          void 0 != g && (g.innerHTML = "Pause"),
            void 0 != i && q.muted && (i.innerHTML = "Unmute"),
            b.toggleState(l.videotoggledby);
        }),
        g(q, "pause", function (c) {
          ...
          !k() &&
            ...
            punchgs.TweenLite.to(a.find(d), 0.3, {
              autoAlpha: 0,
              ease: punchgs.Power3.easeInOut,
            })),
            ...
            (e.videoplaying = !1),
            n(a, e),
            "audio" != d && e.c.trigger("starttimer"),
            e.c.trigger(
              "revolution.slide.onvideostop",
              h(q, "html5", a.data())
            );
          var g = a.find(".tp-vid-play-pause")[0];
          void 0 != g && (g.innerHTML = "Play"),
            (void 0 != e.currentLayerVideoIsPlaying &&
              e.currentLayerVideoIsPlaying.attr("id") != a.attr("id")) ||
              b.unToggleState(l.videotoggledby);
        }),
        g(q, "ended", function () {
          j(),
            n(a, e),
            ...
            !0 === a.data("nextslideatend") &&
              q.currentTime > 0 &&
              (1 == !e.just_called_nextslide_at_htmltimer &&
                (a.data("nextslideatend-triggered", 1),
                e.c.revnext(),
                (e.just_called_nextslide_at_htmltimer = !0)),
              setTimeout(function () {
